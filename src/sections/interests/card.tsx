...
import { deleteFile } from 'src/utils/s3.client';
import { changeNewInterest, gitInterests, openCreateDialog, setEditMode, setError, setInterests } from 'src/redux/slices/InterestsSlice';
...
export default function CatCard({ name, image, description, id }: ListingCardProps) {
...
const handleDelete = async (id: string) => {
  ...
  />
        ...
        <ConfirmDialog
          ...
          content={
            <>
              Are you sure want to delete <strong> {name} </strong> Interest?
            </>
          }
          action={
            <Button
